...
<head>
    ...
    <style>
        ...
        .form-floating, .password-requirements {
            ...
            <div class="login-body">
                ...
                <?php if (!$token_valid): ?>
                    <div class="text-center py-4">
                        ...
                        <h4 class="mt-3">Enlace Inválido o Expirado</h4>
                        <p class="text-muted">El enlace de recuperación no es válido o ha expirado.</p>
                        <a href="index.php?action=forgot_password" class="btn btn-login mt-3">
                ...
                <?php else: ?>
                    ...
                    <!-- Reset Password Form -->
                    <form method="POST" action="index.php?action=reset_password" id="resetPasswordForm">
                        ...
                        <div class="form-floating position-relative">
                            ...
                            <button type="button" class="btn btn-link position-absolute top-50 end-0 translate-middle-y pe-3"
                                    id="toggleConfirmPassword" style="z-index: 10; text-decoration: none; color: #6c757d;">
